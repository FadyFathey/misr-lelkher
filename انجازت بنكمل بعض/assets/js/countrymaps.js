        ...
        var vt = (j.pathBBox = function(t) {
            ...
            kt = ot(function(t, e, r, i, n, s, a, o) {
                var l, h = n - 2 * r + t - (a - 2 * n + r),
                    ...
                    d = [e, o],
                    g = [t, a];
                return ("1e12" < S(f) && (f = 0.5), "1e12" < S(p) && (p = 0.5), 0 < f && f < 1 && ((l = yt(t, e, r, i, n, s, a, o, f)), g.push(l.x), d.push(l.y)), 0 < p && p < 1 && ((l = yt(t, e, r, i, n, s, a, o, p)), g.push(l.x), d.push(l.y)), (h = s - 2 * i + e - (o - 2 * s + i)), (c = e - i), (f = (-(u = 2 * (i - e) - 2 * (s - i)) + B.sqrt(u * u - 4 * h * c)) / 2 / h), (p = (-u - B.sqrt(u * u - 4 * h * c)) / 2 / h), "1e12" < S(f) && (f = 0.5), "1e12" < S(p) && (p = 0.5), 0 < f && f < 1 && ((l = yt(t, e, r, i, n, s, a, o, f)), g.push(l.x), d.push(l.y)), 0 < p && p < 1 && ((l = yt(t, e, r, i, n, s, a, o, p)), g.push(l.x), d.push(l.y)), {
                    min: {
                        x: k[x](0, g),
                        y: k[x](0, d)
                    },
            ...
            if (j.svg) {
                            ...
                            switch (((n[r] = a), r)) {
                                ...
                                case "fill":
                                    ...
                                    if (p.error) {
                                        ...
                                        delete e.gradient, delete n.gradient, !j.is(n.opacity, "undefined") && j.is(e.opacity, "undefined") && L(i, {
                                            opacity: n.opacity
                ...
                ((o.prototype = t).constructor = o), (j._engine.path = function(t, e) {
                    ...
                    for (L(this.canvas, {
                        ...
                        (s = "stroke-width" in o.attrs ? o.attrs["stroke-width"] : 1), o.attr({
                            "stroke-width": s
...
!(function(e) {
    ...
    function f() {
        ...
        function tA() {
            (E = !!a.background_image_url && "no" != a.background_image_url && a.background_image_url), (C = !!a.background_image_bbox && a.background_image_bbox), (W = "yes" == a.background_transparent ? 0 : 1), (X = a.label_size ? a.label_size : 22), (Y = a.label_color ? a.label_color : "#ffffff"), (Q = "yes" == a.url_new_tab), (Z = a.location_opacity ? a.location_opacity : 1), (U = "yes" == a.js_hooks), (G = a.border_size ? a.border_size : 1.5), (J = a.popup_color ? a.popup_color : "#ffffff"), (I = a.popup_orientation ? a.popup_orientation : "auto"), (P = a.popup_centered ? a.popup_centered : "auto"), (ee = a.popup_opacity ? a.popup_opacity : 0.9), (et = a.popup_shadow > -1 ? a.popup_shadow : 1), (eo = a.popup_corners ? a.popup_corners : 5), (ei = "yes" == a.popup_nocss), (K = !!a.popup_maxwidth && a.popup_maxwidth), (en = a.popup_font ? a.popup_font : "12px/1.5 Verdana, Arial, Helvetica, sans-serif"), (V = "no" != a.zoom_out_incrementally), (q = a.adjacent_opacity ? a.adjacent_opacity : 0.3), (T = a.zoom_time ? a.zoom_time : 0.5), (S = a.zoom_increment ? a.zoom_increment : 2), (B = "no" != a.zoom_mobile), (D = a.fade_time ? 1e3 * a.fade_time : 200), (H = t5.labels), (F = a.custom_shapes ? a.custom_shapes : {}), (L = !!a.initial_back && "no" != a.initial_back && a.initial_back), (R = "yes" == a.hide_eastern_labels), (M = a.link_text ? a.link_text : "View Website"), (O = !!a.order_number && a.order_number), (j = a.zoom_percentage ? a.zoom_percentage : 0.99);
        }
        ...
        function tM() {
            (eJ = t5.locations), (eX = []), (eY = []), (eU = []), (eG = []), (eQ = []), (te = []), !(function() {
                var e = {};
                if (((e.color = !1), (e.hover_color = !1), (e.opacity = a.region_opacity ? a.region_opacity : 1), (e.hover_opacity = a.region_hover_opacity ? a.region_hover_opacity : 0.6), (e.url = !1), (e.description = !1), (e.description_mobile = !1), (e.inactive = !1), (e.zoomable = !0), (e.hide_name = "yes" == a.region_hide_name), (e.popup = a.region_popups ? a.region_popups : em), (e.cascade = "yes" == a.region_cascade_all), (e.zoom_percentage = j), (e.x = !1), (e.y = !1), (e.x2 = !1), (e.y2 = !1), z))
                    for (var t in z)
            ...
            if ("lambert" == t6.proj)
                var o = function e(t) {
                    ...
                    return {
                        ...
                        y: a * Math.pow(1 / Math.tan(0.25 * o + 0.3926990925), r) - s * Math.cos(r * (n - 1.57079637))
                    };
                };
            else if ("xy" == t6.proj)
                var o = function e(t) {
        ...
        function tW(e) {
            ...
            var t, o = r.rotate_bbox(e.sm.bbox, eA),
                ...
                c = eb * e0,
                m = e3 * e0;
            return (i -= (a / l - a) * 0.5), (n -= (s / l - s) * 0.5), (a /= l) / (s /= l) > ek ? ((n -= (m * (t = a / c) - s) / 2), (s = a / ek)) : ((i -= (c * (t = s / m) - a) / 2), (a = s * ek)), {
                x: i,
                y: n,
                w: a,
                h: s,
        ...
        function o4(n) {
            ...
            tA(), (function e() {
                ...
                if (!tq) {
                    ...
                    var l = ".tt_mobile_sm{margin-top: .4em;} .tt_sm{" +
                        (t ? t + ": " + o + "px;" : "") +
                        a +
                ...
                var e; of (), ou(), (function e() {
                    ...
                    var t = void 0 === a.navigate_title ? "الاعدادات" : a.navigate_title,
                    ...
                    var n = void 0 === a.states_title ? "المحافظات" : a.states_title,
                            ...
                            if ((ec && !i && ((e = !0), setTimeout(function() {
                                ...
                                if (((el = o.sm.on_click), !t || ((!k || "touchend" != t.type) && (k || "touchstart" != t.type)))) {
                                    if ((el && tz.update_pos(), (tT = o.sm.popup_off), o.sm.zoomable && ("region" == o.sm.type || tc != o || "out" == o.sm.type)))
                                        oF(o, t), oj(), w && w.sm ? t0.call(w, !0, function() {
                                            oe(o), (w = o);
                                        }) : (oe(o), (w = o));
                                    else if (el) {
